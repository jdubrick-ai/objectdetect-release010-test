...
3) Access the `workbench` named `objectdetect-release010-test-notebook`.
...
5) In the terminal, run `cd objectdetect-release010-test` to navigate to your sample app's directory.
